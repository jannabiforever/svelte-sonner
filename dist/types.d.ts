...
export declare function isAction(action: ToastAction | AnyComponent | undefined): action is ToastAction;
...
} & HTMLAttributes<HTMLLIElement> & ToastIcons;
export {};
